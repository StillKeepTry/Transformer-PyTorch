...
def add_model_args(parser):
    ...
    group.add_argument('--hidden_size', type=int, metavar='N',
                       help='The size of hidden state')
    group.add_argument('--filter_size', type=int, metavar='N',
                       help='The filter size')
    group.add_argument('--num_layers', type=int, metavar='N',
                       help='The number of hidden layers')
    group.add_argument('--num_heads', type=int, metavar='N',
